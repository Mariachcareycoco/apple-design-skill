# 🍎 Apple Design Skill — Pixel-Perfect AI Skill for Apple.com-Grade Frontends

**[🇺🇳 English]** **[🇨🇳 中文 ↓]**

## 🚀 What is this?

This is an **AI coding assistant skill** — a set of structured design instructions that trains any AI agent (Codex CLI, Claude Code, Cursor, etc.) to build **Apple.com-grade frontends** with exact design tokens reverse-engineered from Apple's production CSS.

> **⭐ The most premium AI skill for building the most premium UIs.**
...
`ash
git clone https://github.com/Mariachcareycoco/apple-design-skill.git
`

Then tell your AI assistant:

> **"Use apple-design-skill to build a premium landing page"**

The AI will automatically apply all Apple design tokens, component templates, layout rules, and QA checks.
...
- 🔍 **Reverse-engineered** from Apple's production main.built.css
- 🎨 **20+ design tokens** extracted
- 📐 **15+ component templates** documented
- ✅ **10+ QA checks** automated before every output

---

# 🍎 Apple Design Skill — AI 编码助手的像素级苹果设计技能

## 🚀 这是什么？

这是一套 **AI 编程助手技能（Skill）** — 结构化的设计指令集，让你的 AI 代理（Codex CLI、Claude Code、Cursor 等）直接构建**苹果官网级别的前端页面**。
...
- 使用 **AI 编程助手** 的开发者，想要苹果品质 UI 又不想手写每个像素
- 想快速原型化**高端落地页和营销站点**的设计师
- 任何需要**极简高端美学**的人
...
AI 将自动应用所有苹果设计令牌、组件模板和 QA 检查。

## 📊 数据

- 🔍 **逆向工程**自苹果生产环境 main.built.css
- 🎨 **20+** 个设计令牌提取
- 📐 **15+** 个组件模板文档化
- ✅ **10+** 个输出前 QA 检查自动化